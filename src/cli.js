...
function help() {
  console.log(`agent-log-triage v0.1.0

Usage:
  agent-log-triage --path FILE
  agent-log-triage FILE --markdown
  agent-log-triage FILE --sarif > results.sarif
  agent-log-triage FILE --annotations
  agent-log-triage FILE --redact
`)
}
...
try {
  ...
  console.error(`agent-log-triage: ${error.message}`)
  process.exit(2)
}
